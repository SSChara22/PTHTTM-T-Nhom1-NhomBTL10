                        ...
                        <li><i class="ti-location-pin"></i> <a href="{{route('order.track')}}">Theo dõi đơn hàng</a></li>
                            ...
                            @auth 
                                @if(Auth::user()->role=='admin')
                                    <li><i class="ti-user"></i> <a href="{{route('admin')}}"  target="_blank">Trang admin</a></li>
                                @else 
                                    <li><i class="ti-user"></i> <a href="{{route('user')}}"  target="_blank">Trang admin</a></li>
                                @endif
                            ...
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        ...
                                        <a href="{{route('wishlist')}}">Xem danh sách mong muốn</a>
                                    </div>
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span class="total-amount">{{number_format(Helper::totalWishlistPrice(),2)}}đ</span>
                                        </div>
                            ...
                            @auth
                                <div class="shopping-item">
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Tổng</span>
                                            <span class="total-amount">{{number_format(Helper::totalCartPrice(),2)}}đ</span>
                                        </div>
