     ...
     <li class="nav-item">
        ...
        <div id="brandCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('brand.index')}}">Nhà cung cấp</a>
    ...
    <li class="nav-item">
        ...
        <div id="shippingCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('shipping.create')}}">Thêm hình thức vận chuyển</a>
          </div>
        </div>
    </li>
    ...
    <li class="nav-item">
     ...
     <li class="nav-item">
        ...
        <div id="postCategoryCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Danh mục bài đăng:</h6>
            <a class="collapse-item" href="{{route('post-category.index')}}">Danh mục bài đăng</a>
